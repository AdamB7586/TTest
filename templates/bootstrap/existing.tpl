        ...
        <div class="col-md-12">
            <div class="row">
                <div class="row-eq-height">
                    ...
                    <div class="col-xs-3"></div>
                    <div class="col-xs-3">{if isset($continue_test)}<div class="continue btn btn-theory btn-icon" id="{$continue_test}"><span class="fa fa-long-arrow-right fa-fw"></span><span class="hidden-xs btn-text"> Continue Test</span></div>{/if}</div>
                </div>
            </div>
        </div>
    </div>
