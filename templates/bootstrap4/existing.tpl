...
<div class="col-12" id="buttons">
    <div class="row-eq-height w-100">
        ...
        <div class="col-3"></div>
        <div class="col-3"></div>
        <div class="col-3">{if $continue_test}<div class="continue btn btn-theory" id="{$continue_test}"><span class="fas fa-long-arrow-alt-right fa-fw btn-icon"></span><span class="d-none d-sm-inline-block ml-1 btn-text"> Continue Test</span></div>{/if}</div>
    </div>
</div>
